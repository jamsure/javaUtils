...
public class DateUtil {
	...
	public static String DAY_TIME_TYPE = "yyyy-MM-dd HH:mm:ss";
	...
	public static String DAY_TYPE = "yyyy-MM-dd";
	...
	public static int getDateDifference(Date d1,Date d2){
	    ...
	    return   new Long (Math.abs(days)).intValue();
	}
    ...
    /**
     * 批量将日期转为yyyy-MM-dd格式字符串集合
     * @Title: batchDateToStr 
     * @author: zhengy
     * @date: 2017-4-18上午10:20:46
     * @param dates
     * @return
     * @return: List<String>
     */
    public static List<String> batchDateToStr(List<Date> dates){
    	List<String> dateStrs=new ArrayList<String>();
    	for (Date date : dates) {
			dateStrs.add(DateUtil.dateToStr(date, "yyyy-MM-dd"));
		}
    	return dateStrs;
    }
    
    /**
     * 计算两个日期之间天数差（如果有余数则加1）
     * @Title: differDayOfDate 
     * @author: zhengy
     * @date: 2017-4-21上午10:40:06
     * @param start
     * @param end
     * @return
     * @return: int
     */
    public static int differDayOfDate(Date start,Date end){
    	int day= (int) ((start.getTime() - end.getTime()) / 1000 / 60 / 60 / 24);
    	double mod=((start.getTime() - end.getTime()) %( 1000 * 60 * 60 * 24));
    	if(mod>0){
    		day=day+1;
    	}
    	return day;
    ...
    public static Date TimesToDate(String times) {
	    ...
	    Long time=(new Long(times))*1000L;  
